    ...
    stages {
        ...
        stage('Deploy Frontend to Tomcat') {
            steps {
                ...
                xcopy /E /I /Y "FRONTEND\\reactfrontendapp\\dist\\*" "C:\\Program Files\\Apache Software Foundation\\Tomcat 10.1\\webapps\\reactbookapi"
                '''
            }
        }
        ...
        stage('Deploy Backend to Tomcat') {
            steps {
                ...
                copy /Y "BACKEND\\PRACTICEWORKSPACE\\target\\*.war" "C:\\Program Files\\Apache Software Foundation\\Tomcat 10.1\\webapps\\"
                '''
            }
        }
    }
